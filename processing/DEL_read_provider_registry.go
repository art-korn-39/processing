...
// func Read_ProviderRegistry(registry_done chan querrys.Args) {
...
// func PSQL_ReadProviderRegistry_async(registry_done chan querrys.Args) {
...
// 		operation.Channel_currency = currency.New(operation.Channel_currency_str)
// 		operation.Provider_currency = currency.New(operation.Provider_currency_str)
...
// func PSQL_ReadProviderRegistry(registry_done chan querrys.Args) {
...
// func PSQL_ReadProviderRegistry_querry(registry_done chan querrys.Args) {
...
// 		r.Provider_currency = currency.New(r.Provider_currency_str)
...
// func PSQL_ReadProviderRegistry_async_querry(registry_done chan querrys.Args) {
...
// func GetArgsForProviderRegistry(registry_done <-chan querrys.Args) (merchant_names []string, DateFrom, DateTo time.Time) {
